...
| Latest implementation commit | 29b5baa |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `29b5baa`
...
- 1,257 host tests and exact coverage of 91.03% lines, 84.40% branches, and
  87.16% functions;
...
tree at `29b5baa`, with documentation, generated output, and dependency
...
The latest Repowise index covers the code tree after `29b5baa`; the host and
...
index reports 395 files, 91.9% lines, and 84.5% branches. The latest health
...
performance scan reports 98 findings at 12.8 per 10K covered LOC. These findings are
