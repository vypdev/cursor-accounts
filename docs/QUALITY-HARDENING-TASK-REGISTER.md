...
| Latest implementation commit | f21e8d3 |
...
The latest `pnpm run audit` passed on 2026-08-26 at commit `f21e8d3` with:

- extension-host tests: passed across the compiled host test suite;
- 961 host tests and coverage of 83.34% lines, 77.01% branches, and 80.84%
  functions;
