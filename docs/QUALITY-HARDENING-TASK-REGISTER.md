...
| Latest implementation commit | 4bee4f2 |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `4bee4f2`
...
- 1,239 host tests and exact coverage of 90.69% lines, 83.79% branches, and
  86.78% functions;
...
copy of the code tree at `4bee4f2` with documentation, generated output, and
...
The latest Repowise index covers the code tree after `4bee4f2`; the host and
...
87.10% lines and 95.45% branches; the remaining signal is lifecycle/error-path
complexity), `src/proxy/certificateMaterialGenerator.ts` (10.00/10, NLOC 35,
