...
| Latest implementation commit | 23d8f05 |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `23d8f05`
...
copy of the code tree at `23d8f05` with documentation, generated output, and
dependency directories excluded, using no clustering. It scanned 882 code
files and contains 5,297 nodes and 15,752 raw edges; the normalized post-build
diagnostic graph contains 13,736 edges.
...
directed multigraph diagnostic reports 1,858 dangling endpoint edges, one
self-loop, no missing endpoints, and 157 same-endpoint relation groups; it
retains 13,894 valid candidate edges and collapses them to 13,736 normalized
...
The latest Repowise index covers the code tree after `23d8f05`; the host and
