...
| Latest implementation commit | 25f2f1c |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `25f2f1c`
...
tree at `25f2f1c`, with documentation, generated output, and dependency
directories excluded, using no clustering. It scanned 900 code files and
contains 5,379 nodes and 15,248 raw edges; the normalized post-build
diagnostic graph contains 13,012 edges.
...
directed multigraph diagnostic reports 2,077 dangling endpoint edges, one
self-loop, no missing endpoints, and 158 same-endpoint relation groups; it
retains 13,171 valid candidate edges and collapses them to 13,012 normalized
...
The latest Repowise index covers the code tree after `25f2f1c`; the host and
...
index reports 392 files, 91.52% lines, and 84.39% branches. The latest health
snapshot reports average health at 8.97/10, hotspot health at 6.92/10, and
