...
| Latest implementation commit | 3f553ff |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `3f553ff`
...
- 1,193 host tests and coverage of 89.75% lines, 82.76% branches, and 85.96%
  functions;
...
`3f553ff` using `--code-only` and no clustering. It scanned 865 code files and
contains 5,172 nodes and 14,618 raw edges; the directed post-build diagnostic
graph contains 12,460 edges.
...
retains 12,611 valid candidate edges and collapses them to 12,460 directed
...
The latest Repowise index covers the code tree after `3f553ff`; the host and
...
index reports 370 files, 90.1% lines, and 82.2% branches.
Detailed health reports average health at 8.93/10, hotspot health at 6.80/10,
