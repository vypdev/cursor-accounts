...
| Latest implementation commit | eb250bf |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `eb250bf`
...
tree at `eb250bf`, with documentation, generated output, and dependency
directories excluded, using no clustering. It scanned 900 code files and
contains 5,385 nodes and 15,265 raw edges; the normalized post-build
diagnostic graph contains 13,028 edges.
...
retains 13,187 valid candidate edges and collapses them to 13,028 normalized
...
The latest Repowise index covers the code tree after `eb250bf`; the host and
...
snapshot reports average health at 8.97/10, hotspot health at 6.94/10, and
