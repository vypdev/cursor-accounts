...
| Latest implementation commit | b20eb8e |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `b20eb8e`
...
- 1,233 host tests and exact coverage of 90.60% lines, 83.65% branches, and
  86.68% functions;
...
copy of the code tree at `b20eb8e` with documentation, generated output, and
dependency directories excluded, using no clustering. It scanned 882 code
files and contains 5,296 nodes and 15,751 raw edges; the normalized post-build
diagnostic graph contains 13,735 edges.
...
retains 13,893 valid candidate edges and collapses them to 13,735 normalized
...
The latest Repowise index covers the code tree after `b20eb8e`; the host and
