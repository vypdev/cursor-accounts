...
| Latest implementation commit | f497f96 |
...
The latest complete `pnpm run audit` passed on 2026-08-27 at commit `f497f96`
...
tree at `f497f96`, with documentation, generated output, and dependency
directories excluded, using no clustering. It scanned 904 code files and
contains 5,410 nodes and 15,341 raw edges; the normalized post-build
diagnostic graph contains 13,097 directed edges.
...
directed multigraph diagnostic reports 2,081 dangling endpoint edges, one
self-loop, no missing endpoints, and 162 same-endpoint relation groups; it
retains 13,260 valid candidate edges and collapses them to 13,097 normalized
...
The latest Repowise index covers the code tree after `f497f96`; the host and
...
snapshot reports average health at 8.98/10, hotspot health at 6.97/10, and
